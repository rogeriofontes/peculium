...
-- Schema peculium
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `peculium` DEFAULT CHARACTER SET utf8 ;
USE `peculium` ;
...
CREATE TABLE IF NOT EXISTS `peculium`.`location` (
  ...
  `district_id1` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_location_district1_idx` (`district_id1` ASC),
  CONSTRAINT `fk_location_district1`
    FOREIGN KEY (`district_id1`)
...
-- Table `peculium`.`role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `peculium`.`role` (
  `id` INT NOT NULL AUTO_INCREMENT,
